...
class Network(Model):
    def __init__(self):
        ...
        self.SegNetworkWeights = "./ep015-loss0.017-val_acc0.945.h5"
    ...
    def SetEncodeNetworkWeights(self):
        ...
        if os.path.isfile('./EncodeNetWorkWeights.h5'):
            self.EncodeNetwork.load_weights('./EncodeNetWorkWeights.h5')
        else:
            SegModel = SegNetwork()
            ...
            self.EncodeNetwork.save_weights('./EncodeNetWorkWeights.h5')
    ...
    def call(self,inputs):
        ...
        return TL_output, yaw_angle_output, la_diff_output
